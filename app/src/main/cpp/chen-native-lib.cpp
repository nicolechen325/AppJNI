...
extern "C" {
#include "chen_algorithm/chen_algorithm.h"
#include "include/chen_sub.h"
#include "chen_helloworld/hello_world.h"
}
extern "C"
...
const char *const kJNI = "com/pa/chen/appjni/PAJni";
...
//JNIEXPORT和JNICALL都是JNI的关键字，表示此函数是被JNI调用的
//函数命名规则为：Java_类全名_方法名。，它们之间用 _(下划线) 连接

/************************获取JNI中字符串******************/
JNIEXPORT jstring JNICALL
Java_chen_pa_com_nativeandroid_PAJni_nativeGetStrFromJNI(JNIEnv *env, jobject /* this */) {
    const char *hello = "Hello World JNI!";
    LOGV("nativeGetHelloWorld, %s", hello);
    double base = 4;
    int exponent = 3;
    double result = power(base, exponent);
    double output = addFunc(result, 120.0);
    double output2 = subFunc(output, 12.0);
    hello_world(hello);
...
Java_chen_pa_com_nativeandroid_PAJni_nativeSetJObjectValueInNative(JNIEnv *env, jclass clazz,
                                                                   jobject obj) {
...
/*********************************************回调Java方法***************************************/
JNIEXPORT void JNICALL
Java_chen_pa_com_nativeandroid_PAJni_nativeRetriveJava(JNIEnv *env, jclass clazz, jobject obj) {
...
Java_chen_pa_com_nativeandroid_PAJni_nativeParameterArray(JNIEnv *env, jobject obj,
...
JNINativeMethod gMethods[] = {
        {"nativeGetStrFromJNI",           "()Ljava/lang/String;",                     (void *) Java_chen_pa_com_nativeandroid_PAJni_nativeGetStrFromJNI},
        {"nativeSetJObjectValueInNative", "(Lcom/pa/chen/appjni/JNISetObj;)V", (void *) Java_chen_pa_com_nativeandroid_PAJni_nativeSetJObjectValueInNative},
        {"nativeRetriveJava",             "(Lcom/pa/chen/appjni/JNISetObj;)V", (void *) Java_chen_pa_com_nativeandroid_PAJni_nativeRetriveJava},
        {"nativeParameterArray",          "([B)[B",                                   (void *) Java_chen_pa_com_nativeandroid_PAJni_nativeParameterArray},
};
